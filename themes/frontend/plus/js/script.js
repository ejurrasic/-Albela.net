...
function reloadInits() {
    ...
    if($(window).width() > 1000) {
        if ($(".profile-container").length > 0) {
            ...
            $('.middle-container .right-col-content').stick_in_parent({offset_top: 46,bottoming:false,parent:$(".middle-container")});
            $('.middle-container .left-col-content').stick_in_parent({offset_top: 46,bottoming:false,parent:$(".middle-container")});
        }
